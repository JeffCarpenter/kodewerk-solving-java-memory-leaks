...
public class Query {
    ...
    protected DataAccess connect() throws Throwable {
    ...
    public Result getAllKeywords() throws Throwable {
    ...
    public Result getAllTipsForKeyword(String keyword) throws Throwable {
